...
public class LoadGoogleCloudStorageTest {
    ...
    public void testLoadCsv() {
        ...
        System.out.println("GCS MAPPED PORTS = " + gcs.getExposedPorts().stream().map(p -> gcs.getMappedPort(p)));
        System.out.println("GCS NETWORK = " + gcs.getNetwork());
        System.out.println("GCS LOGS = " + gcs.getLogs());
